...
class Assets {
	...
	public function register_styles() {
		...
		wp_register_style( 'main-css', AQUILA_BUILD_CSS_URI . '/clean.css', ['bootstrap-css'], filemtime( AQUILA_BUILD_CSS_DIR_PATH . '/clean.css' ), 'all' );
		...
		// wp_register_style( 'style1-css', AQUILA_BUILD_CSS_URI . '/style.css', [], filemtime( AQUILA_BUILD_CSS_DIR_PATH . '/style.css' ), 'all' );
		// wp_register_style( 'style-css', AQUILA_BUILD_CSS_URI . '/clean.css', [], filemtime( AQUILA_BUILD_CSS_DIR_PATH . '/clean.css' ), 'all' );
